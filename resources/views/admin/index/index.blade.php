...
<html>
  <head>
    ...
    <!-- iCheck -->
    <link href="/framework/plugins/iCheck/square/blue.css" rel="stylesheet" type="text/css" />
  ...
  <body class="login-page">
    <div class="login-box">
      <div class="login-logo">
        <a href="#"><b>Techneter</b></a>
      </div><!-- /.login-logo -->
      <div class="login-box-body">
        <p class="login-box-msg">Techneter</p>
    ...
    <!-- jQuery 2.1.4 -->
    <script src="/framework/plugins/jQuery/jQuery-2.1.4.min.js" type="text/javascript"></script>
    <!-- Bootstrap 3.3.2 JS -->
