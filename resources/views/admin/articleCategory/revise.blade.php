                    ...
                    <div class="col-md-12">
                        ...
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">更新文章分类表单</h3>
                            </div><!-- /.box-header -->
                            ...
                            @if ($type === "create")
                            <form class="form-horizontal" action="/admin/article/category" method="post" >
                            @else
                            <form class="form-horizontal" action="/admin/article/category/{{ $articleCategory->id }}" method="post"  >
                            <input type="hidden" name="_method" value="put" >
                            {{ $parameterPersenter->setReviseModel($articleCategory) }}
                            @endif
